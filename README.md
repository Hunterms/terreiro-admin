...
- **`area-filho.html`** — Área pessoal pública do filho. Painel com tarefas, escalas, reembolso, disponibilidade do mês, afilhados + coluna comunidade (avisos, próximas atividades, rega). Trust-based: PIN de 4 números (o telefone só abre a primeira vez). Esqueceu o PIN? A própria tela destrava: prova o **celular completo** do cadastro e escolhe outro na hora (o aparelho dela e o admin recebem aviso da troca — prova fraca com rastro, porque o número circula no grupo). Quem trocou de número cai no chaveiro humano: o botão "Esqueceu o PIN" na ficha do filho. Não há código por email ou SMS porque a casa não tem os dois canais: 31 dos 56 não têm email. Trocar o PIN de dentro é o 🔑 no cabeçalho da área, e pede o PIN de agora. `disponibilidade.html` permanece como redirect.
